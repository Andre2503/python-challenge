...
print(f"--------------------------")
print(f"The list of candidates is: {candidate_list}") 
print()
print(f"Total votes for {candidate_list[0]} is {total_votes0}")
print(f"Total votes for {candidate_list[1]} is {total_votes1}")
print(f"Total votes for {candidate_list[2]} is {total_votes2}")
print()
print(f"Total number of votes were: {total_votes}")
#print(winner_index)
print(f"The winner is {winner}")
print(f"--------------------------")
print(f"More information in the Analysis text file! - check it out!")
print()
